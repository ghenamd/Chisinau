...
public class FoodDrinkActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        objects.add(new Object("Zaxi Restaurant","\n" +
                "Zaxi brings a sophisticated and elegant experience of fine dining to Chisinau. This upscale restaurant offers a contemporary presentation of the Asian Fusion dining style, respecting the traditions of these diverse food cultures. With a special note comes the Asian Fusion cuisine created by our Award-winning International and Asian chefs. The panoramic views of the city and live music on Tuesdays and Fridays make the dining experience unforgettable.\nAddress: Address: str. Mitropolit Varlaam 77, Chisinau Moldova.\nTel: +373 78 201 210.",R.drawable.zaxi_restaurant));
